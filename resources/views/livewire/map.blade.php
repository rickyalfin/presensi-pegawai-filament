<div class="grid grid-cols-1 dark:bg-gray-900 md:grid-cols-12 gap-4" wire:ignore>
    ...
    <div class="md:col-span-2 bg-white dark:bg-gray-8000 shadow-md rounded-lg p-6">
        <div id="map" class="w-full" style="height: 75vh">
    ...
    <script>
        ...
        document.addEventListener('livewire:initialized', function() {
            ...
            markers.forEach(marker => {
                const str = `Nama : ${marker.user_id}<br>Jam Masuk : ${marker.start_time}`;
